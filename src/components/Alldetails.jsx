...
const Alldetails = () => {
  ...
  <button type="button" class="list-group-item list-group-item-action">Location - Madurai</button>
  ...
  <button type="button" class="list-group-item list-group-item-action" >Conatct Number -  </button>
